...
export class BlackholeRenderer {
  ...
  constructor(userConfig: BlackholeConfig) {
    ...
    this.config = {
      ...
      cameraDistance: userConfig.cameraDistance ?? 8,
      fieldOfView: userConfig.fieldOfView ?? 60,
      ...
      useDiskTexture: userConfig.useDiskTexture ?? false,
      ...
      bloomStrength: userConfig.bloomStrength ?? 1.0,
      bloomRadius: userConfig.bloomRadius ?? 0.5,
      bloomThreshold: userConfig.bloomThreshold ?? 0.6,
